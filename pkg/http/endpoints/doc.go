...
Use this package when building HTTP APIs that require structured endpoint path registration
with validation. It enables grouping middleware with handlers, validating endpoint
...
EndpointHandler interface can register their endpoints with a shared builder, making it easy
to compose endpoints from multiple sources.
*/
package endpoints
